...
name: on-page-seo
description: >
  Comprehensive on-page SEO checklist covering 15 categories and 80+ items for blog posts and service pages.
  Use this skill whenever generating, auditing, or rewriting any web page — blog posts, service pages, landing pages,
  or any content meant to rank in search engines. Trigger on any mention of SEO, writing a blog post, creating a
  service page, page optimization, meta tags, schema markup, internal linking, E-E-A-T, or content that will be
  published on a website. Always read this skill before generating or editing any page content — do not rely on
  general knowledge alone. Note: Technical SEO (sitemaps, robots.txt, Core Web Vitals) is covered separately.
---

# On-Page SEO — Comprehensive Checklist

> 15 categories · 80+ items · applies to every blog post and service page generated.
> Work through every applicable category before finalizing any page output.
...
- **Blog posts**: Apply categories 1–13 and 15 (if 1500+ words).
- **Service pages**: Apply categories 1–13 and 14.
- **All pages**: Categories 1–13 are non-negotiable.
- Technical SEO (sitemaps, robots.txt, Core Web Vitals, page speed) is a separate concern and not covered here.
