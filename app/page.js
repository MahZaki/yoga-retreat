...
export default function Home() {
  ...
  const articles = [
    ...
    { cat: 'Wellness', title: 'What to Expect at a Silent Meditation Retreat', excerpt: 'A first-hand account of spending seven days in silence at a Vipassana center in Thailand.', img: '/images/retreat-meditation.jpg', date: 'May 15, 2026', read: '10 min read' },
  ]
        ...
        <div className="container">
          <div className={s.quizGrid}>
            <div className={s.quizVisual}>
              <Image src="/images/retreat-meditation.jpg" alt="Woman meditating at Bali retreat" fill sizes="50vw" style={{ objectFit: 'cover' }} />
            </div>
