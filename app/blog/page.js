...
const articles = [
  // Pillar
  { slug: 'yoga-retreats', title: 'Yoga retreats: the complete guide to choosing, booking, and preparing', desc: 'Everything you need to know before you book — what retreats actually cost, what a typical day looks like, how to evaluate a teacher, and which destinations suit which budgets. From someone who\'s attended 14 retreats across 9 countries.', category: 'Guide', img: '/images/blog/pillar-what-is.jpg', date: 'Jan 2025', readTime: '14 min', vol: 8100 },
  // Planning cluster
  ...
  { slug: 'yoga-retreat-for-beginners', title: 'Yoga retreat for beginners: what to expect on your first trip', desc: 'First retreats done right: why 4–5 days beats 7, how to choose a level-appropriate programme, and what no one tells you about day one.', category: 'Retreat Types', img: '/images/blog/pillar-typical-day.jpg', date: 'Apr 2025', readTime: '7 min', vol: 260 },
]
