...
const articles = [
  ...
  // Types cluster
  { slug: 'ashtanga-yoga-retreat', title: 'Ashtanga yoga retreats: 6AM starts and the Mysore method', desc: 'The reality of a traditional Ashtanga retreat. Why 6 AM Mysore-style classes are standard, and how to know if you are actually ready for the physical intensity.', category: 'Retreat Types', img: '/images/blog/ashtanga-yoga-hero.jpg', date: 'Aug 2026', readTime: '9 min', vol: 320 },
  { slug: 'vinyasa-yoga-retreat', title: 'Vinyasa yoga retreats: finding a proper physical flow', desc: 'How to avoid retreats that market a "light stretch" as Vinyasa. A guide to finding proper flow sequences and instructors who actually build physical heat.', category: 'Retreat Types', img: '/images/blog/vinyasa-yoga-hero.jpg', date: 'Aug 2026', readTime: '8 min', vol: 480 },
  { slug: 'hot-yoga-retreat', title: 'Hot yoga retreats: tropical humidity vs studio climate', desc: 'The massive difference between practicing in a climate-controlled studio and an open-air tropical shala. What to expect and how to handle the hydration risks.', category: 'Retreat Types', img: '/images/blog/hot-yoga-hero.jpg', date: 'Aug 2026', readTime: '7 min', vol: 260 },
