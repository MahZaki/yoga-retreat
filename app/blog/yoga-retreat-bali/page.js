...
const faqSchema = [
  {
    question: 'Where is the best place in Bali for a yoga retreat?',
    answer: 'Ubud is the best area for a serious yoga retreat — highest concentration of established centres, strongest teaching quality, and the most immersive jungle setting. Canggu suits people who want yoga plus surf and social life. Uluwatu suits those who want premium clifftop surroundings and smaller group sizes.'
  },
  {
    question: 'How much does a yoga retreat in Bali cost?',
    answer: 'Budget retreats in Bali run $600–$900/week full board. Mid-range is $1,000–$1,800/week. Premium retreats cost $1,800–$2,800/week, and luxury $3,000+/week. Canggu is generally the cheapest area; Uluwatu the most expensive.'
  },
  {
    question: 'Do I need a visa to visit Bali for a yoga retreat?',
    answer: 'Most nationalities receive a free 30-day visa on arrival in Indonesia. Stays beyond 30 days require an extension or the e-VOA (electronic Visa on Arrival), available online before travel. For retreats under 30 days, the free visa-on-arrival is sufficient for most passport holders.'
  },
  {
    question: 'What is the best time of year to visit Bali for yoga?',
    answer: 'May to September is the dry season — the most popular time, with full retreat schedules and 20–30% higher prices. November to March brings afternoon rain but mornings are usually clear. January and February offer the best prices and the lushest landscape.'
  },
  {
    question: 'Is Bali worth it for a yoga retreat compared to India or Thailand?',
    answer: 'Bali commands a significant premium over India and Thailand. Comparable teaching quality is available in Rishikesh at 40–60% of the cost. The Bali premium is real for food quality, aesthetics, and the overall travel experience — not for yoga instruction specifically. If you want the best yoga teaching, go to India. If you want great yoga combined with a beautiful holiday destination, Bali earns its price.'
  }
];
...
export default function BaliYogaRetreatPage() {
  return (
    <BlogPost
      ...
      canonicalUrl="https://www.yogaretreatadvisor.com/blog/yoga-retreat-bali"
      tocItems={[
        { href: '#ubud', label: 'Ubud — for serious practice' },
        { href: '#canggu', label: 'Canggu — surf & yoga' },
        { href: '#uluwatu', label: 'Uluwatu — luxury & clifftops' },
        { href: '#prices', label: 'Price comparison' },
        { href: '#bali-vs-india', label: 'Bali vs India (honest take)' },
        { href: '#when', label: 'When to visit' },
        { href: '#watch-out', label: 'What to watch out for' },
        { href: '#visa', label: 'Visa & practical notes' },
        { href: '#faq', label: 'FAQ' },
      ]}
      tags={['Bali', 'Ubud', 'Canggu', 'Uluwatu', 'Destinations', 'Retreat Planning']}
      relatedPosts={[
        ...
        { href: '/blog/yoga-retreats-india', img: '/images/blog/india-yoga.jpg', imgAlt: 'Yoga retreats India', label: 'Destinations', title: 'Yoga retreats India: Rishikesh, Kerala & Mysore — honest guide' },
        { href: '/blog/luxury-yoga-retreats', img: '/images/blog/luxury-yoga.jpg', imgAlt: 'Luxury yoga retreats', label: 'Retreat Types', title: 'Luxury yoga retreats: what $3,000+ actually gets you' },
    ...
    >
      ...
      <p>Within three days, I noticed something off. The daily schedule was being restructured around photogenic moments rather than genuine practice time. The sunrise session moved when the light wasn&apos;t good. A photographer visited for two days, and our cacao ceremony was reshuffled entirely around his schedule. The food was elaborate and photographed constantly by the staff. I came back feeling, to be honest, like I&apos;d been a prop in someone else&apos;s content strategy.</p>

      <p>That experience taught me the single most important thing about choosing a Bali retreat: <strong>I learned in Bali that &quot;Instagram-perfect&quot; and &quot;genuinely nourishing&quot; are not the same thing — and that the retreats that look the best in photos are sometimes the ones working the hardest to distract you from what&apos;s missing.</strong></p>

      <p>That said — Bali is still my most-visited retreat destination, and having explored almost every corner of it since, I can tell you that when the centre is right, nothing else quite matches it. Here is how to tell the difference between the three main hubs: Ubud, Canggu, and Uluwatu.</p>
      ...
      <p>As I mentioned, the Instagram-to-reality gap is wider in Bali than anywhere else I&apos;ve visited. Signs that a retreat has optimised for marketing rather than substance:</p>
      <ul>
